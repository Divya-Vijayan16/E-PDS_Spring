  ...
  <div class="shell">
    <div class="slider-holder">
      <ul>
        ...
        <li>
          <div class="offer-image"> <img src="./css/css/images/offer-image-2.jpg" alt="" /> </div>
          <div class="offer-data">
            <h3>Special Offer</h3>
            <div class="entry">
              <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin sed odio et ante lipsum amet dorem en lobortis. Quisque eleifend, arcu a dictum varius.</p>
        ...
        <li>
          <div class="offer-image"> <img src="./css/css/images/offer-image-3.jpg" alt="" /> </div>
          <div class="offer-data">
            <h3>Special Offer</h3>
            <div class="entry">
              <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin sed odio et ante lipsum amet dorem en lobortis. Quisque eleifend, arcu a dictum varius.</p>
        ...
        <li>
          <div class="offer-image"> <img src="./css/css/images/offer-image-4.jpg" alt="" /> </div>
          <div class="offer-data">
            <h3>Special Offer</h3>
            <div class="entry">
              <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin sed odio et ante lipsum amet dorem en lobortis. Quisque eleifend, arcu a dictum varius.</p>
        ...
        <li>
          <div class="offer-image"> <img src="./css/css/images/offer-image-5.jpg" alt="" /> </div>
          <div class="offer-data">
            <h3>Special Offer</h3>
            <div class="entry">
              <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin sed odio et ante lipsum amet dorem en lobortis. Quisque eleifend, arcu a dictum varius.</p>
  ...
  <div class="shell">
    ...
    <div class="box last-box">
      ...
      <div class="entry bullet-list">
        <ul>
          <li><a href="addShop.jsp">Add new shop</a></li>
          <li><a href="allotProduct.jsp">Allot Product</a></li>
          <li><a href="viewAllotedStock.jsp">View Stock Details</a></li>
           <li><a href="viewrequests.jsp">View Customer Requests</a></li>
        </ul>
      </div>
      <div class="buttons"> <a href="#" class="button"><span>Read More</span></a> </div>
    </div>
