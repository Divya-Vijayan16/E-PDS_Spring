     ...
     <form method="post" action="">
      <div class="admin_body_table">
        <div class="row">
          ...
          <div class="col">
              <input placeholder="username" type="text" name="txtname"  class="admin_body_table_input admin_body_table_col_right"><span id="etxtname" style="color:red;"><%= euserName %></span>
          </div>
          <div class="clear"></div>
        </div>
        <div class="row">
            ...
            <div class="col">
                <input placeholder="password" type="text"  name="txtpass" class="admin_body_table_input admin_body_table_col_right"><span id="etxtpass" style="color:red;"><%=epassword %></span>
            </div>
            <div class="clear"></div>
          </div>
